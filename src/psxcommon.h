...
typedef struct {
	...
	u8 AnalogMode;   /* 0-Digital 1-DualAnalog 2-DualShock (digital mode) 3-DualShock (analog enabled) */
	...
	u8 McdSlots; /* enabled slots, 0=both, 1=slot1, 2=slot2, 3=none */
	u8 McdSlot1; /* mcd slot 1, 0=disabled, 17=CdromId.1.mcr, otherwise mcd%03u.mcr */
	u8 McdSlot2; /* mcd slot 2, 0=disabled, 17=CdromId.2.mcr, otherwise mcd%03u.mcr */
